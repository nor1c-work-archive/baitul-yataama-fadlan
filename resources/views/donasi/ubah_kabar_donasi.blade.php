		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Ubah Kabar Donasi</h3>
				...
				<div class="panel-body">
					<form action="{{route('donasi.kabar.save')}}" class="form-kabar-donasi" role="form" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="subjectKabarDonasi" name="subjectKabarDonasi" placeholder="Subject (judul)" value="{{$kabar_donasi->subject}}">
						</div>
						<div class="form-group">
							<label for="tipeKabarDonasi">Tipe Kabar</label>
							<select id="tipeKabarDonasi" name="tipeKabarDonasi" class="form-control">
								<option value="penarikan_dana" @if($kabar_donasi->tipe_kabar == "penarikan_dana") selected @endif>Penarikan Dana</option>
								<option value="kabar_biasa" @if($kabar_donasi->tipe_kabar == "kabar_biasa") selected @endif>Kabar Biasa</option>
							</select>
						</div>
						<div class="form-group div-jumlah-penarikan">
							<label for="jumlahPenarikan">Jumlah Penarikan Donasi</label>
							<input type="text" class="form-control" id="jumlahPenarikan" name="jumlahPenarikan" placeholder="Jumlah Penarikan Dana" value="{{$kabar_donasi->jumlah_penarikan}}">
						</div>
						<div class="form-group">
							<label for="ceritaDonasi">Isi Kabar</label>
							<textarea class="form-control richTextBox" id="isiKabarDonasi" name="isiKabarDonasi" placeholder="Tulis Kabar Donasi ...">{!! $kabar_donasi->isi !!}</textarea>
						</div>
